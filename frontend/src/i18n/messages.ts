...
export const messages = {
  zh: {
    shell: {
      ...
      darkMode: '深色模式', language: '语言', configureApi: '设置', exportData: '导出数据', documentTitle: '关键词矩阵',
    },
    common: {
    ...
    indexing: {
      ...
      pendingUrls: '待处理 URL：',
      lastRun: '最近任务：',
      setupRequired: 'Google Indexing 由平台托管，当前工作区尚未开放。',
      openSettings: '打开设置',
      intakeTitle: '导入与预处理',
      intakeDesc: '上传 Search Console 导出的 Table.csv 和 Metadata.csv，自动整理出可提交 URL。',
      uploadFiles: '上传 Search Console 导出文件',
      ...
      manualHint: '支持粘贴手动 URL；完成预处理后，也可以一键把可提交结果回填到这里。',
      ...
      noJobs: '暂无任务',
      progressTitle: '提交进度',
      progressDesc: '基于最近一次任务结果显示完成度、成功和失败数量。',
      progressRunning: '任务正在执行，进度条当前显示活动状态，结果返回后会更新为实际完成度。',
      progressCompletion: '完成度',
      progressSuccess: '成功',
      progressFailed: '失败',
      progressPending: '待完成',
      progressInFlight: '处理中',
      prepareFailed: '预处理失败',
    ...
    settings: {
      title: '设置', desc: '管理本地默认设置、AI Provider 与可选集成', modalTitle: '设置', modalDesc: 'AI 默认通过后端调用 Gemini 或 MiniMax。密钥保存在本地 SQLite 设置表中，不会从前端直接调用模型。', geminiKey: 'Gemini 平台密钥', geminiTag: 'Google · 免费配额', minimaxKey: 'MiniMax 平台密钥', minimaxTag: '备用 Provider', toggleMask: '显示或隐藏', geminiConfigured: '已配置 Gemini Key', geminiMissing: '未配置 Gemini Key', minimaxConfigured: '已配置 MiniMax Key', minimaxMissing: '未配置 MiniMax Key', geminiGuideTitle: '如何获取 Gemini 平台密钥：', geminiGuideSteps: ['访问 aistudio.google.com/apikey，使用 Google 账号登录', '点击 Create platform key 并选择项目，然后复制 Key', 'Key 通常以 AIza 开头，GEO Writer、推荐、分析、聊天都会通过后端使用它'], optionalMinimax: '可选 · MiniMax Provider', defaults: '默认设置', defaultProvider: '默认 AI Provider', language: '语言', defaultContentLanguage: '默认文章语言', defaultMarket: '默认市场', defaultTone: '默认语气', defaultArticleType: '默认文章类型', seoIntegrations: '可选 · SEO 集成', serpapi: '平台 Rank', pythonPath: '平台运行时', googleCreds: '平台凭证', saved: '配置已保存。', effectiveReady: '可生效', notConfigured: '未配置', enabled: '已启用', disabled: '已停用', howToGetApi: '平台托管说明', openOfficialSite: '打开官方入口', steps: '获取步骤', notes: '说明', indexingCredentialsGuideTitle: '平台凭证状态',
    },
  },
  en: {
    shell: {
      ...
      darkMode: 'Dark Mode', language: 'Language', configureApi: 'Settings', exportData: 'Export Data', documentTitle: 'Keyword Matrix',
    },
    common: {
    ...
    indexing: {
      ...
      lastRun: 'Last run: ',
      setupRequired: 'Google Indexing is managed by the platform and is not enabled for this workspace yet.',
      ...
      noJobs: 'No jobs yet',
      progressTitle: 'Submission Progress',
      progressDesc: 'Shows completion, success, and failure counts from the latest job summary.',
      progressRunning: 'The job is running. The bar shows active progress now and switches to the actual completion ratio when the result returns.',
      progressCompletion: 'Completion',
      progressSuccess: 'Succeeded',
      progressFailed: 'Failed',
      progressPending: 'Pending',
      progressInFlight: 'Running',
    ...
    settings: {
      title: 'Settings', desc: 'Manage local defaults, AI providers, and optional integrations', modalTitle: 'Settings', modalDesc: 'AI requests go through the backend with Gemini or MiniMax. Keys are stored in the local SQLite settings table and never called directly from the frontend.', geminiKey: 'Gemini 平台密钥', geminiTag: 'Google · Free tier', minimaxKey: 'MiniMax 平台密钥', minimaxTag: 'Secondary provider', toggleMask: 'Show or hide', geminiConfigured: 'Gemini key configured', geminiMissing: 'Gemini key not configured', minimaxConfigured: 'MiniMax key configured', minimaxMissing: 'MiniMax key not configured', geminiGuideTitle: 'How to get a Gemini platform key:', geminiGuideSteps: ['Open aistudio.google.com/apikey and sign in with your Google account', 'Click Create platform key, choose a project, and copy the key', 'Keys usually start with AIza. GEO Writer, recommendations, analysis, and chat all use it through the backend'], optionalMinimax: 'Optional · MiniMax Provider', defaults: 'Default Settings', defaultProvider: 'Default AI Provider', language: 'Language', defaultContentLanguage: 'Default Content Language', defaultMarket: 'Default Market', defaultTone: 'Default Tone', defaultArticleType: 'Default Article Type', seoIntegrations: 'Optional · SEO Integrations', serpapi: '平台 Rank', pythonPath: '平台运行时', googleCreds: '平台凭证', saved: 'Settings saved.', effectiveReady: 'Ready', notConfigured: 'Not configured', enabled: 'Enabled', disabled: 'Disabled', howToGetApi: 'Platform managed', openOfficialSite: 'Open official site', steps: 'Steps', notes: 'Notes', indexingCredentialsGuideTitle: 'Platform credentials status',
    },
  },
