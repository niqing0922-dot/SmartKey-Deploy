...
export const messages = {
  ...
  en: {
    ...
    indexing: {
      ...
      noJobs: 'No jobs yet',
      prepareFailed: 'Failed to prepare uploaded files',
      localParseFailed: 'Local parser found no URLs. You can try AI fallback.',
      uploadFirst: 'Please upload a file first.',
      aiNoUrls: 'AI did not find any URLs.',
      aiParseFailed: 'AI fallback parsing failed.',
      settingsLoadFailed: 'Failed to load settings',
      jobsLoadFailed: 'Failed to load indexing jobs',
      runFailed: 'Failed to run indexing job',
    },
    settings: {
